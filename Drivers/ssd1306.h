 ...
 *  Converted from stm32 to Raspberry Pico
 *  Added features in IRQ mode:
 ...
 *  Added features in IRQ mode with continuous display update:
...
void ssd1306_UpdateCompletedCallback(void); /* you can create a function for the end of the update (attention!: interrupt function) */
#define ssd1306_ContUpdateEnable()
#define ssd1306_ContUpdateDisable()
#define ssd1306_SetRasterInt(r)
...
__attribute__((weak)) void ssd1306_RasterIntCallback(uint8_t r); /* 0:At the beginning of PAGE0, 1:PAGE1, 2:PAGE2 ... 7:PAGE7 (attention!: interrupt function) */
#endif
#endif
#endif
